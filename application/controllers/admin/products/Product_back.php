...
class Product extends CI_Controller {
    ...
    function proc_file_upload(){
        ...
        $config['allowed_types'] = 'gif|jpg|png|pdf|pptx|ppt|xlsx';
    ...
    */
    ...
    function file_chk(){
        ...
        $fileKind = array ('image/pjpeg', 'image/jpeg', 'image/JPG', 'image/X-PNG', 'image/PNG', 'image/png', 'image/x-png', 'application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/vnd.ms-powerpoint', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'application/cdfv2-corrupt', 'application/haansofthwp');      
        ...
        for($i=0; $i<$_POST['file_count']; $i++) {
            ...
            if(isset($_FILES[$file_id]) && !$_FILES[$file_id]['error']&& $_FILES[$file_id]['size']<10485760 ) {
