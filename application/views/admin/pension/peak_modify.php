                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="content-area">
                                ...
                                <fieldset>
                                <legend class="hidden-text">성수기관리수정</legend>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="peak_title" id="peak_title" value ="<?php echo $views->peak_title;?>">
                                                </div>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="peak_type">
                                                        <option value="01" <?php if($views->peak_type == '01') echo "selected"; ?>>준성수기</option>
                                                        <option value="02" <?php if($views->peak_type == '02') echo "selected"; ?>>성수기</option>
                                                        <option value="03" <?php if($views->peak_type == '03') echo "selected"; ?>>극성수기</option>                   
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div class="row">
                                                    <div class="calendar-form col-25">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form date" placeholder="날짜를 선택하세요" name="s_date" value ="<?php echo substr($views->s_date,0,10);?>" readonly>
                                                        </div>
                                                    ...
                                                    <div class="calendar-form col-25">
                                                        <div>
                                                            <label for="" class="hidden-text">날짜지정</label>
                                                            <input type="text" class="form date" placeholder="날짜를 선택하세요"  value ="<?php echo substr($views->e_date,0,10);?>" name="e_date" readonly>
                                                        </div>
                                                        <div class="calendar-panel cal-w100">
                                                            <p class="cal-info"><span class="fas fa-info-circle gray-6 m-r-5"></span>날짜를 선택해주세요.</p>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?php echo $this->config->item('ADMIN_ROOT'); ?>/rent/peak/delete/<?php echo $views->idx ?>')">삭제</button>
                                </div>
