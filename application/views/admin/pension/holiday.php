                                ...
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/pension/holiday/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->year; ?></a></td>
                                        ...
                                        <?php
                                            if($total_row==0){
                                                echo "<tr><td colspan='4' align='center'> 검색된 결과가 없습니다.</td></tr>";
                                            }    
                                        ?><!--// 검색결과 없는 경우 -->
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/pension/holiday/write/')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
