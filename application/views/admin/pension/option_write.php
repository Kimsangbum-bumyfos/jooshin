                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="content-area">
                                ...
                                <fieldset>
                                <legend class="hidden-text">부가서비스등록</legend>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="name" id="name" value="<?=set_value('name')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="number" class="form" name="option_unit_price" id="option_unit_price" value="<?=set_value('option_unit_price')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <textarea class="table-textarea" name="desc" value="" rows="2"></textarea>
                                                </div>                                               
                                            </td>
                                        </tr>
                                        <tr>
