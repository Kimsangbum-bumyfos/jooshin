                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="content-area">
                                ...
                                <fieldset>
                                    <legend class="hidden-text">메뉴콘텐츠관리등록</legend>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="excerpt" id="excerpt" class="form" value="<?=set_value('excerpt')?>" placeholder="부가설명을 입력하세요">
                                                    </div>                                                    
                                                </td>
                                            </tr>
                                            <tr>
