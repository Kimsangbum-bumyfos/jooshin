                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="content-area">
                                ...
                                <input type="hidden" name="menu_up_code" value="<?=$views->menu_up_code?>">
                                <fieldset>
                                    <legend class="hidden-text">메뉴콘텐츠관리수정</legend>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="excerpt" id="excerpt" class="form" value="<?=$views->excerpt;?>">
                                                    </div>                                                    
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-25">
                                                        ...
                                                        <select class="form" name="menu_code">
                                                           <?php echo $menuList; ?>
                                                        </select>
                                                    </div>
                                                </td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/posts/post/delete/<?=$views->idx ?>?v=<?=$v?>')">삭제</button>
                                </div>
