<!DOCTYPE html>
<!--[if IE 8]> <html lang="<?php echo $this->config->item('LANG'); ?>" class="ie8 no-js"> <![endif]-->
<!--[if IE 9]> <html lang="<?php echo $this->config->item('LANG'); ?>" class="ie9 no-js"> <![endif]-->
<!--[if !IE]><!-->
                                                ...
                                                <div class="portlet box green ">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <span class="caption-subject uppercase">메인슬라이드 수정</span>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                    <form class="form-horizontal" method="post" action=""  id="write_action" enctype="multipart/form-data">
                                                    <input type="hidden" name="pc_img" value="<?php echo $views->pc_img;?>"> 
                                                    <input type="hidden" name="mobile_img" value="<?php echo $views->mobile_img;?>"> 
                                                                   ...
                                                                   <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title" id="title" class="form-control input-lg" placeholder="제목" value="<?php echo $views->title;?>">
                                                                            </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                            <textarea class="form-control input-lg" name="sub_title" rows="2" placeholder="부제목"><?php echo $views->sub_title;?></textarea>
                                                                          </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                            <textarea class="form-control input-lg" name="excerpt" rows="2" placeholder="요약내용(지원 테마만 사용)"><?php echo $views->excerpt;?></textarea>
                                                                          </div>
                                                                        </td>
                                                                    </tr>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <select class="bs-select form-control input-lg" data-width="125px" name="status">
                                                                                <option value="Y" <?php if($views->status=='Y') echo "selected"; ?> >게시</option>
                                                                                <option value="N" <?php if($views->status=='N') echo "selected"; ?>>대기</option>';
                                                                            </select>
                                                                          </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                         <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="link_url" id="link_url" class="form-control input-lg" placeholder="링크 URL" value="<?php echo $views->link_url;?>">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-2">
                                                                                <div class="input-icon right">
                                                                                <input type="number" name="order_no" id="order_no" class="form-control input-lg" placeholder="순서"   value="<?php echo $views->order_no;?>">
                                                                            </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 900px; height: 500px;">
                                                                                 <img src = "<?php echo $this->config->item('UPLOAD_DIR'); ?>/<?php echo $views->pc_img;?>">
                                                                            </div>
                                                                            <div>
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 500px; height: 400px;">
                                                                                <img src = "<?php echo $this->config->item('UPLOAD_DIR'); ?>/<?php echo $views->mobile_img;?>">
                                                                            </div>
                                                                            <div>
                                                                                <span class="btn red btn-outline btn-file">
                                                                                    <span class="fileinput-new"> Select image </span>
       ...
       <script>
            ...
            function del(){
                bootbox.confirm("정말로 삭제하겠습니까?", function(result) {
                 if(result){
                  location.href="<?php echo $this->config->item('ADMIN_ROOT'); ?>/main_slide/delete/<?php echo $views->idx ?>";
                 }
              }); 
            }
        </script>  
