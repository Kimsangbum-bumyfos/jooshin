                                ...
                                <table class="table table-typeB">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="title" id="title" value="<?=$views->title;?>" placeholder="팝업 제목을 입력해주세요.">
                                                </div>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="popup_type">
                                                        <option value="01" <?php if($views->popup_type=='01') echo "selected"?>>전체</option>
                                                        <!-- <option value="02" <?php if($views->popup_type=='02') echo "selected"?>>서브페이지</option>                                                         -->
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="calendar-form">
                                                    <div class="col-25">
                                                        ...
                                                        <input type="text" class="form date" placeholder="날짜를 선택하세요"  name="s_date" value="<?=substr($views->s_date,0,10);?>" readonly data-set>
                                                    </div>
                                                    <span class="m-blank">~</span>
                                                    <div class="col-25">
                                                        <label for="" class="hidden-text">종료일</label>
                                                        <input type="text" class="form date" placeholder="날짜를 선택하세요" name="e_date" value="<?=substr($views->e_date,0,10);?>" readonly>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="radio" id="device_type" name="device_type" value="ALL" <?php if($views->device_type=='ALL') echo "checked"?>>
                                                    <label class="radio-label" for="device_type"><span></span>모두</label>

                                                    <input type="radio" id="device_type2" name="device_type" value="PC" <?php if($views->device_type=='PC') echo "checked"?>>
                                                    <label class="radio-label" for="device_type2"><span></span>PC</label>

                                                    <input type="radio" id="device_type3" name="device_type" value="MOBILE" <?php if($views->device_type=='MOBILE') echo "checked"?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="radio" id="cookie_yn" name="cookie_yn" value="Y" <?php if($views->cookie_yn=='Y') echo "checked"?>>
                                                    <label class="radio-label" for="cookie_yn"><span></span>쿠키사용</label>

                                                    <input type="radio" id="cookie_yn2" name="cookie_yn" value="N" <?php if($views->cookie_yn=='N') echo "checked"?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="link_url" value="<?=$views->link_url;?>" placeholder="링크 사용시 주소를 입력해주세요.">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="open_yn">
                                                        ...
                                                        <option value="Y" <?php if($views->open_yn=='Y') echo "selected"?>>진행</option>                                                        
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>                                       
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/contents/popup/delete/<?=$views->idx ?>?v=<?=$v?>')">삭제</button>
                                </div>
