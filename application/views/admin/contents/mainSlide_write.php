                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="content-area">
                                ...
                                <fieldset>
                                <legend class="hidden-text">메인슬라이드관리등록</legend>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="title_header" id="title_header" placeholder="상단 텍스트를 입력해주세요." value="<?=set_value('title_header')?>">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="title" id="title" placeholder="제목을 입력해주세요." value="<?=set_value('title')?>">
                                                </div>
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="title_footer" id="title_footer" placeholder="하단 텍스트를 입력해주세요." value="<?=set_value('title_footer')?>">
                                                </div>
                                            </td>
                                        </tr> -->
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="text1" id="slideText-A" placeholder="슬라이드 텍스트를 입력해주세요.." value="">
                                                </div>
                                            </td>
                                        </tr>
                                        <!-- <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="text2" id="slideText-B" placeholder="슬라이드 텍스트를 입력해주세요." value="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form" name="text3" id="slideText-C" placeholder="슬라이드 텍스트를 입력해주세요." value="">
                                                </div>
                                            </td>
                                        </tr> -->
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="file">
                                                    ...
                                                    <div class="col-100 m-t-8">
                                                        ...
                                                        <input type="file" name="userfile[]" id="input_file2" class="upload-hidden" accept="image/*" value="<?=set_value('userfile[0]')?>">
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form" name="order_no" value="<?=set_value('order_no')?>">
                                                </div>
