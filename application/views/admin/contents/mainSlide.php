                                ...
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/contents/mainSlide/modify/<?=$lt->idx;?>?page=<?=$page?>" class="thumb-img"><img src="<?=base_url().$lt->path.'/'.$lt->pc_img?>"></a></td>
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/contents/mainSlide/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->title; ?></a></td>
                                            <td class="m-hide"><?=$lt->order_no ?></td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/contents/mainSlide/write/')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
