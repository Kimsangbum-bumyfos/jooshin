...
<body>
                                ...
                                <table class="table table-typeB">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    ...
                                                    <input type="text" class="form guidetext" name="car_name" id="car_name" value="<?=set_value('car_name')?>">
                                                </div>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="car_type">
                                                        ...
                                                        <option value="04">고급</option>
                                                        <option value="05">SUV</option>
                                                        <option value="06">승합</option>
                                                        <option value="07">수입</option>
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="checkbox" name="rental_fee_consultation_inquiry" id="rental_fee_consultation_inquiry" value="Y" <?=set_value('rental_fee_consultation_inquiry') ? 'checked' : ''?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="rental_fee" id="rental_fee" value="<?=set_value('rental_fee')?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">정상가격(1일)</label>
                                                    <input type="number" class="form guidetext" name="rental_fee_12" id="rental_fee_12" placeholder="일반가격(1~2일)" value="<?=set_value('rental_fee_12')?>">
                                                </div>
                                                <?=form_error('rental_fee_12','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">정상가격(1일)</label>
                                                    <input type="number" class="form guidetext" name="rental_peak_fee_12" id="rental_peak_fee_12" placeholder="성수기가격(1~2일)" value="<?=set_value('rental_peak_fee_12')?>">
                                                </div>
                                                <?=form_error('rental_peak_fee_12','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">정상가격(1일)</label>
                                                    <input type="number" class="form guidetext" name="rental_high_peak_fee_12" id="rental_high_peak_fee_12" placeholder="극성수기가격(1~2일)" value="<?=set_value('rental_high_peak_fee_12')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="rental_fee_36" id="rental_fee_36" placeholder="일반가격(3~6일)" value="<?=set_value('rental_fee_36')?>">
                                                </div>
                                                <?=form_error('rental_fee_36','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">3~6일가격</label>
                                                    <input type="number" class="form guidetext" name="rental_peak_fee_36" id="rental_peak_fee_36" placeholder="성수기가격(3~6일)" value="<?=set_value('rental_peak_fee_36')?>">
                                                </div>
                                                <?=form_error('rental_peak_fee_36','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">3~6일가격</label>
                                                    <input type="number" class="form guidetext" name="rental_high_peak_fee_36" id="rental_high_peak_fee_36" placeholder="극성수기가격(3~6일)" value="<?=set_value('rental_high_peak_fee_36')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="rental_fee_7" id="rental_fee_7" placeholder="일반가격(7일이상)" value="<?=set_value('rental_fee_7')?>">
                                                </div>
                                                <?=form_error('rental_fee_7','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">7일이상</label>
                                                    <input type="number" class="form guidetext" name="rental_peak_fee_7" id="rental_peak_fee_7" placeholder="성수기가격(7일이상)" value="<?=set_value('rental_peak_fee_7')?>">
                                                </div>
                                                <?=form_error('rental_peak_fee_7','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">7일이상</label>
                                                    <input type="number" class="form guidetext" name="rental_high_peak_fee_7" id="rental_high_peak_fee_7" placeholder="극성수기가격(7일이상)" value="<?=set_value('rental_high_peak_fee_7')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="rental_weekend_fee" id="rental_weekend_fee" value="<?=set_value('rental_weekend_fee')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="add_hours_fee" id="add_hours_fee" value="<?=set_value('add_hours_fee')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="operate_svc" id="operate_svc" placeholder="배차가격" value="<?=set_value('operate_svc')?>">
                                                </div>
                                                <?=form_error('operate_svc','<div class="col-error">', '</div>')?>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">회차가격</label>
                                                    <input type="number" class="form guidetext" name="release_svc" id="release_svc" placeholder="회차가격" value="<?=set_value('release_svc')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <input type="number" class="form guidetext" name="insur_fee" id="insur_fee" value="<?=set_value('insur_fee')?>">
                                                </div>
                                                <?=form_error('insur_fee','<div class="col-error">', '</div>')?>
                                                 <div class="col-50">
                                                    <input type="checkbox" class="insur-input" name="insur_fee_open_yn[]" id="insur_fee_open_yn"  value="01" <?=@in_array('01', set_value('insur_fee_open_yn')) ? 'checked' : ''?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">보험-완전자차</label>
                                                    <input type="number" class="form guidetext" name="insur_fee_10" id="insur_fee_10" value="<?=set_value('insur_fee_10')?>">
                                                </div>
                                                <?=form_error('insur_fee_10','<div class="col-error">', '</div>')?>
                                                <div class="col-50">
                                                    <input type="checkbox" class="insur-input" name="insur_fee_open_yn[]" id="insur_fee_open_yn2"  value="02" <?=@in_array('02', set_value('insur_fee_open_yn')) ? 'checked' : ''?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    <label for="" class="hidden-text">보험-완전자차</label>
                                                    <input type="number" class="form guidetext" name="insur_fee_30" id="insur_fee_30" value="<?=set_value('insur_fee_30')?>">
                                                </div>
                                                <?=form_error('insur_fee_30','<div class="col-error">', '</div>')?>
                                                 <div class="col-50">
                                                    <input type="checkbox" class="insur-input" name="insur_fee_open_yn[]" id="insur_fee_open_yn3"  value="03" <?=@in_array('03', set_value('insur_fee_open_yn')) ? 'checked' : ''?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="checkbox" name="rental_opt[]" id="rental_opt"  value="네비게이션" <?=set_value('rental_opt[0]') ? 'checked' : ''?>>
                                                    <label class="checkbox-label" for="rental_opt"><span></span>네비게이션</label>

                                                    <input type="checkbox" name="rental_opt[]" id="rental_opt2"  value="후방카메라" <?=set_value('rental_opt[1]') ? 'checked' : ''?>>
                                                    <label class="checkbox-label" for="rental_opt2"><span></span>후방카메라</label>

                                                    <input type="checkbox" name="rental_opt[]" id="rental_opt3"  value="금연차량" <?=set_value('rental_opt[2]') ? 'checked' : ''?>>
                                                    <label class="checkbox-label" for="rental_opt3"><span></span>금연차량</label>

                                                    <input type="checkbox" name="rental_opt[]" id="rental_opt4"  value="카시트" <?=set_value('rental_opt[3]') ? 'checked' : ''?>>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="open_yn">
                                                        <option value="N <?=set_value('open_yn') === 'N' ? 'selected' : ''?>">대기</option>
                                                        <option value="Y" <?=set_value('open_yn') === 'Y' ? 'selected' : ''?>>게시</option>
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="checkbox" name="popular_car" id="popular_car"  value="1" <?=set_value('popular_car') ? 'checked' : ''?>>
    ...
    $(document).ready(function(){
        ...
        $("#rental_fee_consultation_inquiry").change(function(){
            if($("#rental_fee_consultation_inquiry").is(":checked")){
                console.log($("#rental_fee_consultation_inquiry").index());
              //2~15
              for(i=5; i<17; i++){
                    $("input")[i].disabled = true;
                    var InputNm="#"+$("input")[i].name;
