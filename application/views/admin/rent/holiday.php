                            ...
                            <div class="content-area">
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$item_no?></td>
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/rent/holiday/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->year; ?></a></td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/rent/holiday/write/')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
