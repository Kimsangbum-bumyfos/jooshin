...
<html lang="<?php echo $this->config->item('LANG'); ?>">
                                                            ...
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                                <input type="text" name="branch_name" id="branch_name" class="form-control" value="<?php echo $views->branch_name;?>"> 
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="col-md-10 form-inline">
                                                                                <input type="text" name="addr_code" id="sample6_postcode" placeholder="우편번호" class="form-control" value="<?php echo $views->addr_code;?>" readonly>
                                                                                <input type="button" class="btn btn-danger  btn-sm" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
                                                                            </div>
                                                                            <div class="col-md-10" style="margin-top:2px">    
                                                                                <input type="text" name ="addr" id="sample6_address" placeholder="주소" class="form-control" value="<?php echo $views->addr;?>" readonly>
                                                                                <input type="text" name ="addr2" id="sample6_address2" placeholder="상세주소" class="form-control" value="<?php echo $views->addr2;?>" style="margin-top:2px">
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                               <input type="text" name="phone1" id="phone1" class="form-control" placeholder="' - '를 포함하여 입력해 주세요(예 : 02-777-1389)" value="<?php echo $views->phone1;?>">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                               <input type="text" name="phone2" id="phone2" class="form-control" placeholder="' - '를 포함하여 입력해 주세요(예 : 02-777-1389)" value="<?php echo $views->phone2;?>">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                               <input type="text" name="fax" id="fax" class="form-control" placeholder="' - '를 포함하여 입력해 주세요(예 : 02-777-1389)" value="<?php echo $views->fax;?>">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                              <textarea name="map_comment" id="map_comment" rows="5" style="width:100%;"><?php echo $views->map_comment;?></textarea>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="col-md-12">
                                                                              <textarea name="add_comment" id="add_comment" rows="3" style="width:100%;"><?php echo $views->add_comment;?></textarea>
    ...
    <script>
            ...
            function del(){
                bootbox.confirm("정말로 삭제하겠습니까?", function(result) {
                 if(result){
                  location.href="<?php echo $this->config->item('ADMIN_ROOT'); ?>/branch_mgr/delete/<?php echo $views->idx ?>";
                 }
              }); 
            }
        </script>
