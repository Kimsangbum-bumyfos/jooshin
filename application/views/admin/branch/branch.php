                                    ...
                                    <form method="get" id="search">
                                        <fieldset>
                                            ...
                                            <div class="col-100 with-btn fl-r">
                                                ...
                                                <input type="text" class="form" placehol="검색어를 입력하세요" id="searchWord" name="search_word" value="<?=$search_word ?>">
                                ...
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/branch/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->branch_name; ?></a></td>
                                            <td>(<?=$lt->addr_code ?>) <?=$lt->addr ?> <?=$lt->addr2 ?></td>
