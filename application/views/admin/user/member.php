                                ...
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/user/member/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->user_name; ?></a></td>
                                            <td><?=$lt->user_id ?></td>
                                            <td><?=$lt->user_phone ?></td>
                                            <td><?=$lt->agreement ?></td>
                                            <td><span class="color-positive">
                                                <?php if($lt->status=='Y') echo "정상"; else echo "탈퇴"; ?></span>
                                            </td>
