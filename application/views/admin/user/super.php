                                     ...
                                     <form id="search" method="get">
                                        <fieldset>
                                            ...
                                            <div class="col-100 with-btn fl-r">
                                                ...
                                                <button type="button" class="btn btn-with-form" id="search_btn"><i class="fas fa-search">&nbsp;</i>검색</button>
                                            </div>
                                        </fieldset>
                                    </form>
                                </div>
                                ...
                                <table class="table table-typeA">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/user/super/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->auth_name; ?></a></td>
                                            <td><?=$lt->auth_id; ?></td>
                                            <td><?=$lt->auth_email; ?></td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/user/super/write')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
