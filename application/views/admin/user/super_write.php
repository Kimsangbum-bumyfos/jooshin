                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-50">
                                                    ...
                                                    <input type="text" name="auth_name" id="auth_name" class="form" placeholder="이름을 입력하세요" value="<?=set_value('auth_name')?>">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-50 with-btn-m m-b-5">
                                                    ...
                                                    <input type="text" name="auth_id" id="auth_id" class="form p-l-20" placeholder="아이디를 입력하세요" value="<?=set_value('auth_id')?>">
                                                    <button type="button" id="id_dupl_chk" class="btn btn-with-form typeA-blue">중복검사</button>
                                                </div>
                                                <?=form_error('auth_id','<div class="col-error">', '</div>')?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>이메일 *</th>
                                            <td>
                                                <div class="col-50 with-btn-m m-b-5">
                                                    ...
                                                    <input type="text" name="auth_email" id="auth_email" class="form p-l-20" placeholder="이메일를 입력하세요" value="<?=set_value('auth_email')?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-50">
                                                    ...
                                                    <input type="password" name="auth_passwd" id="auth_passwd" class="form" placeholder="비밀번호을 입력하세요">
                                                </div>
