        ...
        <script>
            $(document).ready(function() {
                $("#search_btn").click(function() {
                        if($("#q").val()==''){
                            var act = "<?php echo $this->config->item('ADMIN_ROOT'); ?>/member_address/lists/page/1";
                        }else{
                            var act = "<?php echo $this->config->item('ADMIN_ROOT'); ?>/member_address/lists/q/" + $("#q").val() + "/page/1";    
                        }                        
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-users"></i>주소록 관리 </div> 
                                                    </div>
                                                    <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                   <?php
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td class="col-md-1"> <?php echo $item_no ?> </td>
                                                                        <td class="col-md-6"> 
                                                                            <a href="javascript:modify('<?php echo $this->config->item('ADMIN_ROOT'); ?>/member_address/modify/<?php echo $lt -> idx; ?>/page/<?php echo $this->uri->segment(5); ?>')">
                                                                            <?php echo $lt -> address_title; ?> 
                                                                            </a>
                                                                        </td>
                                                                        <td class="col-md-1"> 
                                                                            <?php echo $lt -> tot_cnt; ?> 
                                                                        ...
                                                                        <td class="col-md-1">
                                                                            <?php echo $lt -> receive_yn; ?> 
                                                                        </td>
                                                                        <td class="col-md-2"> <?php echo substr($lt -> reg_date,0,10); ?> </td>
                                                                    </tr>
                                                                     <?php
                                                                        $item_no--;
                                                                        } 
                                                        ...
                                                        <div align="right" class="form-actions noborder">
                                                            <a href="<?php echo $this->config->item('ADMIN_ROOT'); ?>/member_address/write/page/<?php echo $this -> uri -> segment(5); ?>">
