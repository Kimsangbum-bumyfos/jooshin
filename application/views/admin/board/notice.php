                            ...
                            <div class="content-area">
                                <table class="table table-typeA">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$item_no ?></td>
                                            <td class="txt-left"><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/board/notice/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->title; ?></a></td>
                                            <td><?=$lt->view_cnt; ?></td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/board/notice/write/')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
