                                                ...
                                                <td>
                                                    <div class="col-25">
                                                        ...
                                                        <select class="form" name="category">
                                                            <option value="주문/결제" <?php if($views->category == '주문/결제') echo "selected"; ?>>주문/결제</option>
                                                            <option value="제품관련" <?php if($views->category == '제품관련') echo "selected"; ?>>제품관련</option>
                                                            <option value="이용관련" <?php if($views->category == '이용관련') echo "selected"; ?>>이용관련</option>
                                                            <option value="기타" <?php if($views->category == '기타') echo "selected"; ?>>기타</option>
                                                        </select>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/board/faq/delete/<?=$views->idx ?>?v=<?=$v?>')">삭제</button>
                                </div>
