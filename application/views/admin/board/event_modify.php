                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="title" id="title" class="form" value="<?=$views->title;?>">
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="sub_title" id="sub_title" class="form" value="<?=$views->sub_title;?>">
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="calendar-form">
                                                        <div class="col-25">
                                                            ...
                                                            <input type="text" class="form date" placeholder="날짜를 선택하세요"  name="s_date" id="s_date" value="<?=substr($views->s_date,0,10);?>" readonly data-set>
                                                        </div>
                                                        <span class="m-blank">~</span>
                                                        <div class="col-25">
                                                            <label for="" class="hidden-text">종료일</label>
                                                            <input type="text" class="form date" placeholder="날짜를 선택하세요" name="e_date" id="e_date" value="<?=substr($views->e_date,0,10);?>" readonly>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="tags" class="form" placeholder="태그는 ',(쉼표)'로 구분하세요." value="<?=$views->tags;?>">
                                                    </div>
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                                <th>섬네일이미지</th>
                                                <td>
                                                    <div class="preview-img" style="background: url('<?=$views->path.'/'.$views->thumb_img?>') 50% center / 100%;"></div>
                                                    <div class="file">
                                                        ...
                                                        <div>
                                                            ...
                                                            <script>
                                                                CKEDITOR.replace( 'contents', {
                                                                    filebrowserUploadUrl: '<?=$this->config->item('ADMIN_ROOT'); ?>/CKE_Upload/cke_upload?k=<?=$views->cke_key?>'
                                                                });
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/board/event/delete/<?=$views->idx ?>?v=<?=$v?>')">삭제</button>
                                </div>
