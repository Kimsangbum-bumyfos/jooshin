		...
		<div class="login-area">
			...
			<div class="content-panel password">
				<div class="panel-title">
					<h1>안내</h1>
					<h2>비밀번호 유효시간이 초과 하였거나 <br>유효하지 않은 이메일입니다.<br>비밀번호 찾기를 통해 다시 시도하세요.</h2>
				</div>
				<div class="form-group">
					<button class="btn-login" onclick="goPage('<?php echo $this->config->item('ADMIN_BASE_URL'); ?>/login')">확인</button>
				</div>
			</div>
		</div>
	</div>
