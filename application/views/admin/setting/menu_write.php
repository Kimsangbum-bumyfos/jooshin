                                ...
                                <table class="table table-typeB">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="template_type">
                                                        <option value="01" selected>TypeA</option>
                                                        <option value="02">TypeB</option>
                                                        <option value="03">TypeC</option>                       
                                                    </select>                                                    
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <label for="" class="hidden-text">메뉴헤더</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-100">
                                                    <input type="checkbox" name="sub_menu_yn" id="sub_menu_yn" value="Y" <?=set_value('sub_menu_yn') ? 'checked' : ''?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="file">
                                                    ...
                                                    <?=form_error('userfile[2]','<div class="col-error">', '</div>')?>
                                                </div>
                                            </td>
                                        </tr>                                       
