            ...
            <div class="section">
                <div class="section-content">
                    ...
                    <div class="section-body">
                            ...
                            <div class="content-area">
                                <table class="table table-typeA">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$lt->menu_order; ?></td>
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/setting/menu/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->menu_name; ?></a></td>
                                            ...
                                            <td><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/setting/menu/subMenu/<?=$lt->menu_code;?>?page=<?=$page?>" class="underline">하위메뉴관리</a></td>
                                        </tr>
                                        <?php
                        ...
                        <div class="modify-guide-area hide">
                            <span><i></i>아이콘을 드래그하여 메뉴순서를 이동하세요</span>
                        </div>
                        <div class="row">
                            <div class="content-area">
                         ...
                         <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r width-100">
                                    ...
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/setting/menu/write/')" class="btn typeA-blue fl-r">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
