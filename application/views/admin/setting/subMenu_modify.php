                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-50">
                                                    ...
                                                    <input type="number" class="form" name="menu_order" id="menu_order"  value="<?=$views->menu_order;?>">
                                                    <input type ="hidden" id="menu_level" value="2">
                                                    <input type ="hidden" id="menu_up_code" value="<?php echo $views->menu_up_code;?>">
                                                </div>
                                            ...
                                            <td>
                                                <div class="col-25">
                                                    ...
                                                    <select class="form" name="menu_type">
                                                        ...
                                                        <option value="BOARD_EVENT" <?php if($views->menu_type=='BOARD_EVENT') echo "selected";?>>게시판-이벤트</option>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/setting/menu/subMenuDelete/<?=$views->idx ?>?v=<?=$v?>')" >삭제</button>
                                </div>
