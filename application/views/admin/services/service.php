                                ...
                                <table class="table table-typeA">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/services/service/modify/<?=$lt->idx;?>?page=<?=$page?>" class="thumb-img"><img src="<?=base_url().$lt->path.'/'.$lt->thumb_img?>"></a>
                                            </td>
                                            <td class="txt-left"><a href="<?=$this->config->item('ADMIN_BASE_URL'); ?>/services/service/modify/<?=$lt->idx;?>?page=<?=$page?>" class="underline"><?=$lt->title; ?></a></td>
                                            <td class="m-hide">
                                                <?php
                                                    switch($lt->category){
                                                        case "1":
                                                            echo "<span>토목/건축/구조물 시험</span>";
                                                            break;
                                                        case "2":
                                                            echo "<span>항공/기계/자동차 시험</span>";
                                                            break;
                                                        case "3":
                                                            echo "<span>재료 부품 시험</span>";
                                                            break;
                                                        case "4":
                                                            echo "<span>비디오 게이지 활용 시험</span>";
                                                            break;
                                                        case "5":
                                                            echo "<span>기타 시험</span>";
                                                            break;
                                                        default:
                                                            echo "<span>토목/건축/구조물 시험</span>";
                                                            break;
                                            ...
                                            <td class="m-hide"><span><?=$lt->buyer; ?></span></td>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-r">
                                    <button onclick="goPage('<?=$this->config->item('ADMIN_BASE_URL'); ?>/services/service/write/')" class="btn typeA-blue">신규</button>
                                </div>
                            </div>
                        </div>
                    </div>
