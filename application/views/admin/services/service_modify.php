            ...
            $("#write_btn").click(function() {
                ...
                // }
                    ...
                    if(sel_files.length > 0 || $('#img_list').val() != dupList){
                        si = true;
                        fileUploadAction(dupList, 'services/service'); // 파일업로드
                    }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="title" id="title" class="form" value="<?=$views->title;?>" placeholder="제목을 입력하세요">
                                                    </div>
                                                ...
                                                <td class="clearfix">
                                                    <div class="col-33 fl-l">
                                                       ...
                                                       <select name="category" id="category" class="form">
                                                           <option value="1" <?php if($views->category == '1') echo "selected";?>>토목/건축/구조물 시험</option>
                                                           <option value="2" <?php if($views->category == '2') echo "selected";?>>항공/기계/자동차 시험</option>
                                                           <option value="3" <?php if($views->category == '3') echo "selected";?>>재료 부품 시험</option>\
                                                           <option value="4" <?php if($views->category == '4') echo "selected";?>>비디오 게이지 활용 시험</option>
                                                           <option value="5" <?php if($views->category == '5') echo "selected";?>>기타 시험</option>
                                                       </select> 
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- <tr>
                                                ...
                                                <td>
                                                    <div class="col-50 m-b-5">
                                                        ...
                                                        <input class="form form-50 p-l-20" type="text" name="postcode" value="<?=$views->postcode;?>" id="postcode" readonly>
                                                    ...
                                                    <div class="col-100 m-b-5">
                                                        ...
                                                        <input class="form" type="text" name="addr" id="address" value="<?=$views->addr;?>" readonly>
                                                    </div>
                                                    <div class="col-100">
                                                        <label for="" class="hidden-text">상세 주소</label>
                                                        <input class="form" type="text" name="addr_detail" id="address2" value="<?=$views->addr_detail;?>" placeholder="상세주소를 입력해주세요." value="">
                                                    </div>
                                                </td>
                                            </tr> -->
                                           <!--  <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="buyer" id="buyer" class="form" value="<?=$views->buyer;?>" placeholder="발주처를 입력해주세요.">
                                                    </div>
                                                </td>
                                            </tr> -->
                                            <!-- <tr>
                                                ...
                                                <td>
                                                    <div class="col-100">
                                                        ...
                                                        <input type="text" name="scale" id="scale" class="form" value="<?=$views->scale;?>" placeholder="규모를 입력해주세요.">
                                                    </div>
                                                </td>
                                            </tr> -->
                                            <tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="calendar-form col-25">
                                                            <div>
                                                                ...
                                                                <input type="text" class="form date single-limit" placeholder="시작일을 선택해주세요." id="s_date" name="s_date"  value="<?=substr($views->s_date,0,10);?>" readonly>
                                                            </div>
                                                        ...
                                                        <div class="calendar-form col-25">
                                                            <div>
                                                                <label for="" class="hidden-text">날짜지정</label>
                                                                <input type="text" class="form date single-limit" placeholder="종료일을 선택해주세요." id="e_date"  name="e_date" value="<?=substr($views->e_date,0,10);?>" readonly>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="content-area clearfix">
                                <div class="btn-group fl-l">
                                    <button class="btn typeA-gray" onclick="goDelete('<?=$this->config->item('ADMIN_ROOT'); ?>/services/service/delete/<?=$views->idx ?>?v=<?=$v?>')">삭제</button>
                                </div>
