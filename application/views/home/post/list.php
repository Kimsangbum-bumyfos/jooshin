...
<html lang="ko">
<head>
    <link rel="canonical" href="<?= base_url();?>home/post?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />
    <meta charset="UTF-8" />
    ...
    <meta property="og:url" content="<?= base_url();?>home/post?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>">
    ...
    <meta name="twitter:url" content="<?= base_url();?>home/post?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />  
...
<body>
    ...
    <div class="wrap">
        ...
        <div id="skip_container" class="container">
            ...
            <div id="section_list" class="section-t">
                <div class="list-group-t clearfix">
                    <!-- Ajax Post -->
                </div>
            </div>
            <div class="section-t dp-ib">
                <div class="list-btn-area wp-box" data-animate-effect="fadeInUp">
                    <button type="button" id="" class="btn-list-more post-list-more"><span>더보기</span></button>
                </div>
            </div>
        </div><!-- //container -->
        <!-- FOOTER -->
