...
<html lang="ko">
<head>
    <link rel="canonical" href="<?= base_url();?>home/support/faq?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />
    <meta charset="UTF-8" />
    ...
    <meta property="og:url" content="<?= base_url();?>home/support/faq?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>">
    ...
    <meta name="twitter:url" content="<?= base_url();?>home/support/faq?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />  
...
<body>
    ...
    <div id="skip">
        ...
        <a rel="bookmark" href="#skip_faq_category">카테고리 영역 바로가기</a>
        <a rel="bookmark" href="#skip_faq_area">자주묻는 질문 영역 바로가기</a>
        <a rel="bookmark" href="#search-faq">검색 영역 바로가기</a>
        <a rel="bookmark" href="#more_faqList">자주묻는 질문 더보기 바로가기</a>
    </div>
    <!-- //스킵 내비게이션 -->
	<div class="wrap">
		<!-- header -->
		...
		<div id="skip_container" class="container">
            ...
            <div class="section-t section-faq clearfix">
                <!-- 검색영역 -->
                <div class="b-search-area">
                    <div class="sub-search-box">
                        <label for="search-faq">
                            <input type="text" id="search-faq" class="b-search" placeholder="키워드를 검색하세요.">
                            <span id="btn-faq-search" class="ico-b-search"></span>
                        </label>
                    </div>
                </div>
                <!-- // 검색영역 -->
                <!-- 카테고리 -->
                <div id="skip_faq_category" class="faq-category-list">
                    <span class="faq-category-item active" data-category="">전체</span>
                    <span class="faq-category-item" data-category="회원가입">회원가입</span>
                    <span class="faq-category-item" data-category="결제">결제</span>
                    <span class="faq-category-item" data-category="이용관련">이용관련</span>
                    <span class="faq-category-item" data-category="실시간예약">실시간예약</span>
                    <span class="faq-category-item" data-category="기타">기타</span>
                </div>
                <!-- // 카테고리 -->
                <!-- 자주묻는질문 -->
                <div id="skip_faq_area" class="faq-area">
                    <div class="faq-box">
                    <!-- FAQ List Ajax -->
                    </div>
                </div>
                ...
                <div class="section-t">
                    <div class="list-btn-area wp-box fadeInUp animated-fast">
                        <button type="button" id="more_faqList" class="btn-list-more sub-more-btn"><span>더보기</span></button>
                    </div>
                </div>
                <!-- // 더보기 -->
            </div>
