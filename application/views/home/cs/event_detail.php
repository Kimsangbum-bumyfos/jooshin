...
<html lang="ko">
<head>
    <link rel="canonical" href="<?= base_url();?>home/support/event?idx=<?= $idx ?>&menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />
    <meta charset="UTF-8" />
    ...
    <meta property="og:url" content="<?= base_url();?>home/support/event?idx=<?= $idx ?>&menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>">
    ...
    <meta name="twitter:url" content="<?= base_url();?>home/support/event?idx=<?= $idx ?>&menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />  
...
<body>
    ...
    <div id="skip">
        ...
        <a rel="bookmark" href="#skip_return_event">게시글 목록 영역 바로가기</a>
    </div>
    <!-- //스킵 내비게이션 -->
    <div class="wrap">
        <!-- header -->
        ...
        <div id="skip_container" class="container">
            ...
            <div class="section section-notice-read">
                <div class="b-section-body" id="event_read">
            ...
            <div class="section-t dp-ib">
                <div class="list-btn-area">
                     <button type="button" id="skip_return_event" class="btn-list-more board-list" onclick="location.href='<?=base_url()?>home/support/event?menu_code=<?=$menu_code?>&menu_up_code=<?=$menu_up_code?>'"><span>목록</span></button>
                </div>
            </div>
        </div><!-- //container -->
        <!-- FOOTER -->
