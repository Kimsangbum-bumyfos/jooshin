...
<html lang="ko">
<head>
    <link rel="canonical" href="<?= base_url();?>home/support/notice?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />
    <meta charset="UTF-8" />
    ...
    <meta property="og:url" content="<?= base_url();?>home/support/notice?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>">
    ...
    <meta name="twitter:url" content="<?= base_url();?>home/support/notice?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />  
...
<body>
    ...
    <div id="skip">
        ...
        <a rel="bookmark" href="#tbody-noti">공지사항 영역 바로가기</a>
        <a rel="bookmark" href="#more_notiList">공지사항 더보기 영역 바로가기</a>
    </div>
    <!-- //스킵 내비게이션 -->
	<div class="wrap">
		<!-- header -->
            ...
            <div class="section-t section-notice clearfix">
                ...
                <div class="b-search-area">
                    <div class="sub-search-box">
                        <label for="search-noti">
                            <input type="text" id="search-noti" class="b-search" placeholder="키워드를 검색하세요.">
                            <span id="btn-noti-search" class="ico-b-search"></span>
                        </label>
                    </div>
                </div>
                <!-- // 검색영역  -->
                <!-- 공지사항 -->
                <div class="b-row">
                    <table class="b-table b-table-typeA">
                        <colgroup>
                            <col style="width:6%;">
                            <col style="width:72%;">
                            <col style="width:6%;">
                ...
                <div class="section-t">
                    <div class="list-btn-area wp-box fadeInUp animated-fast">
                        <button type="button" id="more_notiList" class="btn-list-more sub-more-btn"><span>더보기</span></button>
                    </div>
                </div>
                <!-- // 더보기 -->
            </div>
