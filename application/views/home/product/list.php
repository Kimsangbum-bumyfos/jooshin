...
<html lang="ko">
<head>
    <link rel="canonical" href="<?= base_url();?>home/product?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />
    <meta charset="UTF-8" />
    ...
    <meta property="og:title" content="제품소개 | (주)주신산업" />
    <meta property="og:site_name" content="@(주)주신산업" />    
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?= base_url();?>home/product?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>">
    ...
    <meta name="twitter:title" content="제품소개 | (주)주신산업" />
    ...
    <meta name="twitter:url" content="<?= base_url();?>home/product?menu_code=<?= $menu_code ?>&menu_up_code=<?= $menu_up_code ?>" />  
    <meta name="twitter:site" content="@(주)주신산업" />    
    <meta name="twitter:creator" content="@(주)주신산업" />     

    <title>제품소개 | (주)주신산업</title>
    ...
    <script>
        ...
        var pageType = 'list';
        var list_base_url = '<?= base_url(); ?>home/product?menu_code='+mCode+'&menu_up_code='+mUpCode+'';
    </script>
...
<body>
    ...
    <div class="wrap">
        ...
        <div id="skip_container" class="container">
            <div class="section-t section-bg trail-frame">
                ...
                <div class="section-bg-img">
                    ...
                    <div class="trail-box">
                        <div id="list_trail" class="section-1024 clearfix">
                            ...
                            <div id="trail_depth3" class="trail-item hide mobile-f toggle-item">
                                <span id="trail_depth3_txt"></span>
                                <ul id="trail_item_depth3" class="trail-item-depth trail-item-depth3"></ul>
                            </div>
                            <div id="select_mobile_1" class="select-mobile">
                                <select name="" id="trail_select_depth1"></select>
                            </div>
                            <div id="select_mobile_2" class="select-mobile">
                                <select name="" id="trail_select_depth2"></select>
                            </div>
                            <div id="select_mobile_3" class="select-mobile">
                                <select name="" id="trail_select_depth3"></select>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="product-wrap clearfix">
                <div class="product-snb">
                    <!-- snb_product -->
                    <?php $this->load->view('home/product/snb_product'); ?>
                    <!-- // snb_product -->
                </div>
                <div class="product-container">
                    <div class="product-snb-sub">
                        <div class="product-search">
                            <label for="searchProduct">
                                <input type="text" id="searchProduct" placeholder="제품검색" value="<?= $search_word ?>">
                                <span id="ico_searchProduct"></span>
                            </label>
                        </div>
                        <!-- depth3 -->
                        <ul id="list_depth_3" class="hide clearfix"></ul>
                        <!-- // depth3 -->
                    </div>
                    <!-- getList -->
                    <div id="list_product" class="product-section clearfix"></div>
                    <!-- // getList -->
                    <!-- <div class="js-list-more hide">
